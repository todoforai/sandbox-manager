...
<!-- coverage:start -->
Generated by `scripts/smoke-vm.sh report` from `.smoke/results.tsv`. Last run: 2026-09-04T12:01:52+02:00 (pass=10 fail=2 skip=0).
...
| anydoc | ✅ 1 | – | – | – | – |
| agent-browser | ✅ 1 | – | – | – | – |
| browser-manager-cli | ✅ 1 | – | – | – | – |
| todoforai-browser | ✅ 1 | – | – | – | – |
| tfa-wait | ✅ 1 | ✅ 1 | – | – | – |
| tfa-vault | ✅ 1 | ✅ 1 | – | – | – |
| tfa-memory | ✅ 1 | ❌ tfa-memory.whoami | – | – | – |
| todoregistry-cli | ✅ 1 | ✅ 1 | – | – | – |
| bun | ✅ 2 | – | – | – | – |
| bunx | ✅ 2 | – | – | – | – |
| node | ✅ 2 | – | – | – | – |
| python3 | ✅ 2 | – | – | – | – |
...
Non-tool checks: ✅ auth/credentials.json
<!-- coverage:end -->
