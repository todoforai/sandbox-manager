...
async fn main() -> Result<()> {
    ...
    let admin_api = Router::new()
        ...
        .route("/admin/api/sandbox/:id/restart-bridge", post(api::admin::restart_bridge))
    ...
    let app = Router::new()
        ...
        .route("/sandbox/:id/restart-bridge", post(api::sandbox::restart_bridge))
        .route("/sandbox/:id/balloon", post(api::sandbox::balloon_sandbox))
        .route("/sandbox/:id/exec", post(api::sandbox::exec_sandbox))
        .route("/sandbox/:id/scan_tools", post(api::sandbox::scan_tools_sandbox))
